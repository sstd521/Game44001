...
(function (riggerLayout) {
    var ErrorStrings = /** @class */ (function () {
...
* name;
*/
var LayaLayoutItem = /** @class */ (function (_super) {
    __extends(LayaLayoutItem, _super);
    function LayaLayoutItem(item) {
        return _super.call(this, item) || this;
    }
    Object.defineProperty(LayaLayoutItem.prototype, "itemX", {
        get: function () {
            return this.item.x;
        },
        set: function (v) {
    ...
    Object.defineProperty(LayaLayoutItem.prototype, "itemY", {
        get: function () {
            return this.item.y;
        },
        set: function (v) {
    ...
    Object.defineProperty(LayaLayoutItem.prototype, "itemWidth", {
        get: function () {
    ...
    Object.defineProperty(LayaLayoutItem.prototype, "itemHeight", {
        get: function () {
    ...
    Object.defineProperty(LayaLayoutItem.prototype, "itemScaleX", {
        get: function () {
    ...
    Object.defineProperty(LayaLayoutItem.prototype, "itemScaleY", {
        get: function () {
    ...
    Object.defineProperty(LayaLayoutItem.prototype, "itemPivotX", {
        get: function () {
    ...
    Object.defineProperty(LayaLayoutItem.prototype, "itemPivotY", {
        get: function () {
    ...
    return LayaLayoutItem;
}(riggerLayout.LayoutItem));

/*
* name;
*/
var LayaTopContainer = /** @class */ (function () {
    function LayaTopContainer(item) {
        this.item = item;
    }
    LayaTopContainer.prototype.setItem = function (item) {
        this.item = item;
    };
    LayaTopContainer.prototype.getDesignWidth = function () {
        if (this.item instanceof fairygui.GComponent) {
            return this.item.initWidth;
        }
        else {
            return this.item.designWidth;
        }
    };
    LayaTopContainer.prototype.getDesignHeight = function () {
        if (this.item instanceof fairygui.GComponent) {
            return this.item.initHeight;
        }
        return this.item.designHeight;
    };
    LayaTopContainer.prototype.getRealWidth = function () {
        return Laya.Browser.width;
    };
    LayaTopContainer.prototype.getRealHeight = function () {
        return Laya.Browser.height;
    };
    LayaTopContainer.prototype.onResize = function (caller, method, args) {
        this.item.on(Laya.Event.RESIZE, caller, method, args);
    };
    LayaTopContainer.prototype.offResize = function (caller, method) {
        this.item.off(Laya.Event.RESIZE, caller, method);
    };
    LayaTopContainer.prototype.dispose = function () {
        this.item = null;
    };
    return LayaTopContainer;
}());

/*
* Rigger适配对象，用于管理全局的适配层
*/
var RiggerLayout = /** @class */ (function () {
    function RiggerLayout() {
    }
    Object.defineProperty(RiggerLayout, "layer", {
        /**
         * 默认适配层
         */
        get: function () {
            return RiggerLayout.getLayer(RiggerLayout.DefaultLayerName);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RiggerLayout, "subLayer", {
        /**
         * 子舞台
         */
        get: function () {
            return RiggerLayout.getLayer(RiggerLayout.SubLayerName);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(RiggerLayout, "topLayer", {
        /**
         * 顶舞台
         */
        get: function () {
            return RiggerLayout.getLayer(RiggerLayout.TopLayerName);
        },
        enumerable: true,
        configurable: true
    });
     ...
     * @param layer
     */
    RiggerLayout.addDefaultLayer = function (layer) {
        RiggerLayout.addLayer(RiggerLayout.DefaultLayerName, layer);
    };
    /**
     * 添加一个适配层
     * @param layerName
     * @param layer
     */
    RiggerLayout.addLayer = function (layerName, layer) {
        layer.name = layerName;
        this.layerDict[layerName] = layer;
    };
    /**
     * 获取层
     * @param layerName
     */
    RiggerLayout.getLayer = function (layerName) {
        return this.layerDict[layerName];
    };
    RiggerLayout.DefaultLayerName = "DefaultLayer";
    RiggerLayout.TopLayerName = "TopLayer";
    RiggerLayout.SubLayerName = "SubLayer";
    RiggerLayout.InfoBarLayerName = "InfoBarLayerName";
    RiggerLayout.layerDict = {};
    return RiggerLayout;
}());
...
* 适配辅助类;
*/
var RiggerLayoutHelper = /** @class */ (function () {
    function RiggerLayoutHelper() {
    }
    /**
     * 创建一个以屏幕宽高比为条件的适配规范
     * @param minRatio
     ...
     * @param max
     */
    RiggerLayoutHelper.createScreen = function (minRatio, maxRatio, value, min, max) {
        if (min === void 0) { min = null; }
        if (max === void 0) { max = null; }
        return riggerLayout.LayoutSpec.createByCustom(RiggerLayoutHelper, RiggerLayoutHelper.isScreenFit, [minRatio, maxRatio], value, min, max);
    };
    /**
     * 创建一个仅横屏生效的适配规范
     * @param value
     ...
     * @param max
     */
    RiggerLayoutHelper.createScreenL = function (value, min, max) {
        if (min === void 0) { min = null; }
        if (max === void 0) { max = null; }
        return RiggerLayoutHelper.createScreen(1, -1, value, min, max);
    };
    /**
     * 创建一个仅竖屏生效的适配规范
     * @param value
     ...
     * @param max
     */
    RiggerLayoutHelper.createScreenP = function (value, min, max) {
        if (min === void 0) { min = null; }
        if (max === void 0) { max = null; }
        return RiggerLayoutHelper.createScreen(0, 1, value, min, max);
    };
    /**
     * 获取屏幕的宽高比
     */
    RiggerLayoutHelper.getScreenRatio = function () {
        return Laya.Browser.width / Laya.Browser.height;
    };
    RiggerLayoutHelper.isScreenFit = function (min, max) {
        if (riggerLayout.LayoutSpec.isIgnored(min) && riggerLayout.LayoutSpec.isIgnored(max))
            return true;
        if (riggerLayout.LayoutSpec.isIgnored(min)) {
            return RiggerLayoutHelper.getScreenRatio() <= max;
        }
        if (riggerLayout.LayoutSpec.isIgnored(max)) {
            return RiggerLayoutHelper.getScreenRatio() >= min;
        }
        var ratio = RiggerLayoutHelper.getScreenRatio();
        return ratio >= min && ratio <= max;
    };
    return RiggerLayoutHelper;
}());
...
* name;
*/
var SubLayerLayout = /** @class */ (function (_super) {
    __extends(SubLayerLayout, _super);
    function SubLayerLayout() {
     ...
     * @param height
     */
    SubLayerLayout.prototype.afterLayout = function (x, y, width, height) {
        // 根据顶舞台和信息栏调整子舞台位置和大小
        var topLayer = this.target.getElementByName(RiggerLayout.TopLayerName);
        var infoBarLayer = this.target.getElementByName("infoBarGroup");
        var mainMenuGroup = this.target.getElementByName("mainMenuGroup");
        var gamblingGroup = this.target.getElementByName("gamblingGroup");
        var subLayer = this.target.getElementByName(RiggerLayout.SubLayerName);
        if (mainMenuGroup && gamblingGroup && infoBarLayer) {
            if (!subLayer)
                return;
            if (width >= height) {
                topLayer.realHeight = 0;
                subLayer.realY = topLayer.realY + topLayer.realHeight;
                subLayer.realX = mainMenuGroup.realX + 75 / 551 * mainMenuGroup.realWidth;
                subLayer.realHeight = infoBarLayer ? infoBarLayer.realY - topLayer.realY + (116 - 73) / 116 * infoBarLayer.realHeight : height - topLayer.realHeight;
                subLayer.realWidth = width - gamblingGroup.realWidth + (435 - 143) / 435 * gamblingGroup.realWidth - subLayer.realX;
            }
            else {
                topLayer.realHeight = width * 360 / 640;
                subLayer.realY = topLayer.y + topLayer.realHeight;
                subLayer.realX = 0;
                subLayer.realWidth = width;
                subLayer.realHeight = height - topLayer.realHeight;
            }
            topLayer.applyRealSize();
            topLayer.applyRealPos();
            topLayer.updateAndApplyChildrenLayout();
            subLayer.applyRealSize();
            subLayer.applyRealPos();
            subLayer.updateAndApplyChildrenLayout();
        }
    };
    return SubLayerLayout;
}(riggerLayout.LayoutBase));
...
(function (riggerLayout) {
    var Group = /** @class */ (function (_super) {
        ...
        Group.prototype.applyRealSize = function () {
            var oldWidth = this.mScaleX === 0 ? this.rectangle.width : this.rectangle.width / this.mScaleX;
            var oldHeight = this.mScaleY === 0 ? this.rectangle.height : this.rectangle.height / this.mScaleY;
        ...
        Group.prototype.decideHeightByTopAndBottom = function () {
            if (riggerLayout.Utils.isNullOrUndefined(this.top) || riggerLayout.Utils.isNullOrUndefined(this.bottom))
                return false;
            var parentWidth = this.getParentRealWidth();
            var parentHeight = this.getParentRealHeight();
        ...
        Group.prototype.decideWidthByLeftAndRight = function () {
            if (riggerLayout.Utils.isNullOrUndefined(this.left) || riggerLayout.Utils.isNullOrUndefined(this.right))
                return false;
            var parentWidth = this.getParentRealWidth();
            var parentHeight = this.getParentRealHeight();
...
var riggerLayout;
(function (riggerLayout) {
    var LayoutLayer = /** @class */ (function (_super) {
...
(function (riggerLayout) {
    var LayoutSpec = /** @class */ (function () {
         ...
         * @param v
         */
        LayoutSpec.isIgnored = function (v) {
        ...
        LayoutSpec.prototype.calculateRealValueByScreenSize = function (realWidth, realHeight) {
            // 无限制条件
            if (LayoutSpec.isIgnored(this.maxRatioOrArgs) && LayoutSpec.isIgnored(this.minRatioOrFunction))
                return new riggerLayout.LayoutValue(this.value, this.min, this.max);
            var realRatio = realWidth / realHeight;
            // 忽略最小宽高比
            if (LayoutSpec.isIgnored(this.minRatioOrFunction) && realRatio <= this.maxRatioOrArgs)
                return new riggerLayout.LayoutValue(this.value, this.min, this.max);
            // 忽略最大宽高比
            if (LayoutSpec.isIgnored(this.maxRatioOrArgs) && realRatio >= this.minRatioOrFunction)
                return new riggerLayout.LayoutValue(this.value, this.min, this.max);
            // 刚好在区间内
        ...
        LayoutSpec.prototype.calculateRealValueByCustom = function (realWidth, realHeight) {
            var args = (this.maxRatioOrArgs).concat([realWidth, realHeight]);
...
var riggerLayout;
(function (riggerLayout) {
    var LayoutValue = /** @class */ (function () {
