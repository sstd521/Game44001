...
declare module riggerLayout {
    class LayoutSpec {
        ...
        private thisObj;
        /**
         * 最小父容器宽高比 LayoutSpecType.ScreenSize下，此字段表示最小宽高比,否则表示判断函数
         */
        private minRatioOrFunction;
        /**
         * 最大父容器宽高比， LayoutSpecType.ScreenSize下，此字段表示最大宽高比,否则表示判断函数的参数列表
         */
         ...
         * @param v
         */
        static isIgnored(v: any): boolean;
        /**
         * 计算真实的布局参数
         * @param realWidth 真实屏幕宽
         * @param realHeight 真实屏幕高
        ...
        private calculateRealValueByScreenSize;
        private calculateRealValueByCustom;
        /**
         * 根据最大与最小限制计算最终值
         * @param parentWidth
         * @param parentHeight
         ...
         * @param limit 此条件下的限定值
         */
        private static createInstWithSizeCondition;
        /**
         * 以自定义条件创建一个实例
         * @param fun
         * @param args
         * @param limit
         */
        private static createInstWithCustom;
    }
}
