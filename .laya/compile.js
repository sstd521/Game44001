...
let browserifyConfigs = require('./browserifyConfigs.json')
...
gulp.task("compile", prevTasks,function (done) {
	let path = browserifyConfigs.pluginPath.concat(browserifyConfigs.servicePath);
	let dir = path.concat(['src/hunter/Main.ts']);
